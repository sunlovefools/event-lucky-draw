...
const MISSING_ACCOUNT_MESSAGE = "We couldn't find that badge. Please contact admin to create your account.";
  ...
  const handleCode = useCallback(
    async (value: string) => {
      ...
      try {
        ...
        setScanError("Could not check your badge. Please try again.");
      }
      ...
      hideOverlay();
      setScanError((current) => current ?? MISSING_ACCOUNT_MESSAGE);
      setChecking(false);
  ...
  return (
    <section className="card" aria-labelledby="register-title">
      <div className="section-head">
        ...
        <span className="badge badge-info">Badge login</span>
      </div>
